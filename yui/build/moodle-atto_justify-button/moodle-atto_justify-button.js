YUI.add('moodle-atto_justify-button', function (Y, NAME) {
...
/**
 * @module moodle-atto_justify-button
 */

/**
 * Atto text editor justify plugin.
 *
 * @namespace M.atto_justify
 * @class button
 * @extends M.editor_atto.EditorPlugin
 */

Y.namespace('M.atto_justify').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
